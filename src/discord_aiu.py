...
class DiscordImageUploader:
    ...
    def __init__(self, webhook_url: str, max_workers: int = 50,
        ...
        Parameters:
            ...
            backoff_delay (int): Initial backoff delay in seconds (default: 5)
        """
...
Examples:
  ...
  python script.py
    ...
    parser.add_argument('--backoff-delay', type=int, default=5,
                       help='Initial backoff delay in seconds (default: 5)')
